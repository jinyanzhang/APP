...
# from model.backbones import cpn, sh
...
class GenSequenceDataset(Dataset):
    def __init__(self,
                 data_dir='/home/xxxxxx/MotionAGFormer/data/motion3d/3DHPImages_81_9',
        ...
        self.pkl_files = self.pkl_files[38660*2:115982]
    ...
    def __getitem__(self, index):
        ...
        with open(read_path, 'rb') as file:
            image_paths = pickle.load(file)['image']
        file.close()
...
if __name__ == '__main__':
    ...
    dataset = GenSequenceDataset(
        data_dir=data_dir,
        images_dir='/data-home/MPI_INF_3DHP/images_384_288',
