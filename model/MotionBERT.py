...
class MotionBERT(nn.Module):
    def __init__(self, dim_in=3, dim_out=3, dim_feat=512, dim_rep=512,
                 ...
                 qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0., drop_path_rate=0., norm_layer=nn.LayerNorm, att_fuse=True, return_mid=False):
        super().__init__()
...
def _test():
    ...
    model = MotionBERT(return_mid=True).cuda()
    model.eval()
