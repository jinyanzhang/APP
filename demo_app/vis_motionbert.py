...
def get_pose2D(video_path, output_dir):
    ...
    print('\nGenerating 2D pose...')
    _, _, keypoints, _, _, scores = hrnet_pose(video_path, det_dim=416, num_peroson=1, gen_output=True)
...
def get_pose3D(video_path, output_dir):
    ...
    ## Reload 
    model = MotionBERT(maxlen=243, dim_feat=512, mlp_ratio=2, depth=5, dim_rep=512, num_heads=8, att_fuse=True)
...
if __name__ == "__main__":
    ...
    output_dir = f'/data-home/output/{video_name}_motionbert/'
