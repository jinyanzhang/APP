...
class GenSequenceDataset(Dataset):
    def __init__(self,
                 data_dir='/data1/motion3d/3DHPImages_81_9'):
    ...
    def __getitem__(self, index):
        ...
        with open(read_path, 'rb') as file:
            motion_2d = pickle.load(file)[f'joints_2d']
        file.close()
...
if __name__ == '__main__':
    ...
    data_dir='/data1/motion3d/3DHPImages_81_9'
    checkpoint_path = f'/data-home/checkpoints/motionbert-scratch-3dhp.pth.tr'
    ...
    model = MotionBERT(maxlen=81, dim_feat=512, mlp_ratio=2, depth=5, dim_rep=512, num_heads=8, att_fuse=True, return_mid=True)
    state_dict = {}
    ...
    dataset = GenSequenceDataset(data_dir=data_dir)
