...
if __name__ == '__main__':
    ...
    checkpoint_path = f'/data-home/checkpoints/mixste-h36m-cpn-author.pth.tr'
    ...
    model = MixSTE(in_chans=2, embed_dim_ratio=512, depth=8, num_heads=8, mlp_ratio=2.,
                   qkv_bias=True, qk_scale=None, drop_path_rate=0.1, n_frames=243,
                   num_joints=17, return_mid=True)
    state_dict = {}
