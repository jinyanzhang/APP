...
if __name__ == '__main__':
    ...
    checkpoint_path = f'/data-home/checkpoints/transformer-h36m-sh.pth.tr'
    ...
    model = Transformer(dim_in=3, dim_out=3, dim_feat=128, dim_rep=512, depth=12, num_heads=8,
                        mlp_ratio=4, qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0.,
                        drop_path_rate=0., att_fuse=True, mode='stage_ts_ts', return_mid=True)
    state_dict = {}
